export class Vector {
    ...
    static add(arr1: number[], arr2: number[], arrDest: number[] = null) : number[] {
        if(arr1.length != arr2.length) {
            throw new Error("Vector sizes do not match");
        }
        var des: number[] = arrDest != null ? arrDest : new Array<number>(arr1.length);
    ...
    static sub(arr1: number[], arr2: number[], arrDest: number[] = null) : number[] {
        if(arr1.length != arr2.length) {
            throw new Error("Vector sizes do not match");
        }
        var des: number[] = arrDest != null ? arrDest : new Array<number>(arr1.length);
    ...
    static cross(arr1: number[], arr2: number[], arrDest: number[] = null) : number[] {
        if(arr1.length != arr2.length || arr1.length != 3) {
            throw new Error("Vector lengths must be a length of 3!");
        }
        var des = arrDest != null ? arrDest : new Array<number>(arr1.length);
        if(des.length > arr1.length) {
            des.splice(arr1.length-1);
        }
    ...
    static normalize(arr: number[]) : void {
        var mag: number = Vector.getMag(arr);
        if(mag == 0) {return;}
        for(var i = 0; i < arr.length; i++) {
            arr[i] /= mag;
        }
    ...
    static toString(arr: number[], precision: number = -1) : string {
        if(arr.length == 0) {
            return "[Empty Vector]";
        }
        var str = "[";
        for(const num of arr) {
            var s: string = precision == -1 ? num + "" : num.toFixed(precision);
            str += s + ",";
        }
...
class AbstractWebGLMatrix {
    ...
    setEqualTo(arr: readonly number[] | Readonly<AbstractWebGLMatrix>) {
    ...
    */ 
    ...
    addAll(...matrices: Array<AbstractWebGLMatrix | number[]>) {
    ...
    subAll(...matrices: Array<AbstractWebGLMatrix | number[]>) {
        for(const mat of matrices) {
            this.sub(mat);
        }
    }
    ...
    static toString(mat: AbstractWebGLMatrix, rows: number, cols: number, precision: number = 20) : string {
        var str = "[\n";
...
export class Mat4 extends AbstractWebGLMatrix {
    ...
    static identity(out: Mat4 = null) : void | Mat4 {
        ...
        o[14] = 0;
        o[15] = 1;
        if(out == null) {return mat;}
    }

    static orthographic(left: number, right: number, top: number, bottom: number, nearPlane: number, farPlane: number, out: Mat4 = null) {
    ...
    static perspective(angle: number, aspect_ratio: number, nearPlane: number, farPlane: number, out: Mat4 = null) {
        var o = out == null ? new Mat4() : out;
    ...
    static mult(out: Mat4, m1: Mat4, m2: Mat4) {
        out.setEqualTo(m1);
        out.mult(m2);
    }

    static multAll(out: Mat4, ...matrices: Array<Readonly<Mat4>>) {
    ...
    */
    ...
    multAll(...matrices: Array<Readonly<Mat4>>) {
        for(const mat of matrices) {
            this.mult(mat);
        }
    }
    ...
    getMat3(out: Mat3 = null) : Mat3 | void {
        var a = new Array(9);
        a[0] = this.arr[0];
        a[1] = this.arr[1];
        a[2] = this.arr[2];
    ...
    setRotationAxis(angle: number, axis: number[]) {
        axis = axis.slice();
    ...
    rotateAlongAxis(angle: number, axis: number[]) {
        var temp = new Mat4();
    ...
    inv() {
        var a: number[] = this.arr;
        var newArr: number[] = new Array(16);
    ...
    toString(precision: number = 20) : string {
...
export class ModelMat4 extends Mat4 {
    ...
    override translate(x: number, y: number, z: number) {
        this.arr[12] += x;
        this.arr[13] += y;
        this.arr[14] += z;
    }
    ...
    override setRotationAxis(angle: number, axis: number[]) {
    ...
    override rotateAlongAxis(angle: number, axis: number[]): void {
    ...
    setRotationVectors(foward: number[], right: number[], up: number[]) {
    ...
    translateAlongVector(distance: number, vector: number[]) {
    ...
    getPos(out: number[] = null) {
        var o: number[] = out == null ? new Array(3) : out;
        o[0] = this.arr[12];
        o[1] = this.arr[13];
        o[2] = this.arr[14];
        if(out == null) {return o;}
    ...
    getScaling(out: number[] = null) : number[] | void {
        var o: number[] = out == null ? new Array(3) : out;
    ...
    getFowardVector(out: number[] = null) {
        var o: number[] = out == null ? new Array(3) : out;
        o[0] = this.arr[8];
        o[1] = this.arr[9];
        o[2] = this.arr[10];
    ...
    getRightVector(out: number[] = null) {
        var o: number[] = out == null ? new Array(3) : out;
        o[0] = this.arr[0];
        o[1] = this.arr[1];
        o[2] = this.arr[2];
    ...
    getNormalMatrix(out: Mat3 = null) {
        var o: Mat3 = out == null ? new Mat3() : out;
        this.getMat3(o);
        o.transpose();
        o.inv();
        if(out == null) {return o;}
...
export class Mat3 extends AbstractWebGLMatrix {
    ...
    static identity(out: Mat3 = null) : void | Mat3{
