import {Model, WebGLManager, Camera, Light, Scene} from "../PrivateRyRender.js";
import { SceneComponent } from "../Scene.js";

export class WebGLRenderer {
    private readonly gl: WebGLRenderingContext;
    public readonly manager: WebGLManager; 

    private clearColor: number[] = [0.0,0.0,0.0,1.0];
    private drawModelRef: Function;

    constructor(canvas: HTMLCanvasElement, useBestGPU: boolean = true) {
        let webglOptions: WebGLContextAttributes;
    ...
    private drawModel(model: SceneComponent) {
