...
export class FileLoader {
    ...
    */
    static async loadObj(file: string) : Promise<{vertices: number[], uv: number[], normals: number[], indices: number[]}> {
        ...
        var tempVertices: number[][] = [];
        var tempUV: number[][] = [];
        var tempNormals: number[][] = [];
        var vertIndices: number[] = [];
        var uvIndices: number[] = [];
        var normIndices: number[] = [];
    ...
    static async loadMTL(file: string) : Promise<{mat: Material, texPath: string}> {
    ...
    private static async getFile(file: string) : Promise<Response> {
